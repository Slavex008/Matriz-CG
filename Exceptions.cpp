...
MatrizNulaException::MatrizNulaException(int linha, string nome) :
        Exception::Exception(linha, nome, "A matriz não possui valor válido!") {}

string MatrizNulaException::getMessage() {
    return Exception::getMessage();
}
